...
for y in range(0,20):
    for x in range(0,17):
        ...
        if(grid[x][y]*grid[x+1][y]*grid[x+2][y]*grid[x+3][y] > largest):
            largest = grid[x][y]*grid[x+1][y]*grid[x+2][y]*grid[x+3][y]

for x in range(0,17):
    for y in range(0,17):
        if (grid[x][y]*grid[x][y+1]*grid[x][y+2]*grid[x][y+3] > largest):
            largest = grid[x][y]*grid[x][y+1]*grid[x][y+2]*grid[x][y+3]
        if (grid[y+3][x]*grid[y+2][x+1]*grid[y+1][x+2]*grid[y][x+3] > largest):
            largest = grid[y+3][x]*grid[y+2][x+1]*grid[y+1][x+2]*grid[y][x+3]
